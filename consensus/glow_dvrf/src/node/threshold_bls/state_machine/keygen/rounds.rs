...
use crate::node::threshold_bls::party_i;
...
pub struct LocalKey {
    pub(in crate::node::threshold_bls::state_machine) shared_keys: party_i::SharedKeys,
    pub(in crate::node::threshold_bls::state_machine) vk_vec: Vec<GE2>,

    pub(in crate::node::threshold_bls::state_machine) i: u16,
    pub(in crate::node::threshold_bls::state_machine) t: u16,
    pub(in crate::node::threshold_bls::state_machine) n: u16,
}
...
pub enum ProceedError {
    ...
    Round2VerifyCommitments(crate::node::Error),
    #[error("round 3: verify vss construction: {0:?}")]
    Round3VerifyVssConstruct(crate::node::Error),
    #[error("round 4: verify dlog proof: {0:?}")]
    Round4VerifyDLogProof(crate::node::Error),
}
