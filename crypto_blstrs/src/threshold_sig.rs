...
use crate::crypto::{anyhow, Polynomial};
...
use crate::crypto::threshold_sig::{CombinableSignature, PartialKey, PublicKey, SamplableKey, SecretKey, SharableKey, Signature};
...
pub mod tests {
    ...
    use bincode;
    use crate::crypto::threshold_sig::SignatureSet;
